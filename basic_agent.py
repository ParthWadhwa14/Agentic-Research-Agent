...
def decision_agent(state: BasicAgent) -> Dict[str, Any]:
    ...
    system_instructions = (
        ...
        "Use recent conversation history as memory. If the user shared their name or preferences earlier in this chat, remember and use them. "
...
def run_research_agent(
    ...
    initial_state = {
        ...
        "context": {
            ...
            "live_data": build_live_search_context(query_text),
        }
    }
